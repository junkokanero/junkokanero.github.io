...
>>>>>>> parent of 4e63484 (Update quiat8 - French.js)
				...
				instCategoriesPractice:  '<div><p align="center" style="font-size:20px; font-family:arial">' +
					...
					'Veuillez répéter le mot ci-dessous à voix haute. Vous devrez continuer à répéter ce mot durant toutes la partie.<br/></b></p>' + 
					'<p style="font-size:20px; text-align:center">' + VERB1 + '<br/>' +
					'<u> Allez aussi loin que possible </u> en essayant d’être précis.<br/>' +
					'Appuyez sur <b>la barre espace</b> quand vous êtes prêt à commencer.</font></p></div>',
				...
				instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
					...
					'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
					'« Vous pouvez arrêter de répéter ! »</b><br/>'+
					'Dans cette partie, nous vous demanderons de répartir des objets dans les catégories “Habillement” et “Outils”, ainsi que de répartir des visages selon les catégories “Femme” ou “Homme”.<br/></b>' +
					'Veuillez positionner votre doigt gauche sur la touche E et votre doigt de droite sur la touche I de votre clavier.<br/>' +
				...
				instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
					'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
					'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
					'« Vous pouvez arrêter de répéter ! »</b>'+
