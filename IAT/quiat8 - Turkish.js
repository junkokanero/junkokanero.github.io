		...
		function iatExtension(options)
		{
			...
			blockSwitch_nMiniBlocks : 1,
				...
				instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
					...
					'Bu bölümde sizden gördüğünüz yüzleri "Kadın" veya "Erkek" olarak kategorilere ayırmanız istenecektir.<br/><br/></p>' +
					'Lütfen sol el parmağınızı klavyenizdeki E tuşunun üzerine, sağ el parmağınızı ise I tuşunun üzerine yerleştiriniz.<br/><br/></p>' +
					'<font color="#0000ff">leftAttribute</font> kategorisine ait yüzler için <b>E</b> tuşuna basınız.<br/>' +
					'<font color="#0000ff"">rightAttribute</font> kategorisine ait yüzler için <b>I</b> tuşuna basınız.<br/><br/></p>' +
				...
				instCategoriesPractice:  '<div><p align="center" style="font-size:20px; font-family:arial">' +
					'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
					'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
					'Bu bölümde sizden gördüğünüz nesneleri “Giyecek” veya “Alet” olarak kategorilere ayırmanız istenecektir.<br/><br/></p>' +
					'Lütfen sol el parmağınızı klavyenizdeki E tuşunun üzerine, sağ el parmağınızı ise I tuşunun üzerine yerleştiriniz.<br/><br/></p>' +
					'<font color="#336600">leftAttribute</font> kategorisine ait nesneler için <b>E</b> tuşuna basınız.<br/>' +
					'<font color="#336600">rightAttribute</font> kategorisine ait nesneler için <b>I</b> tuşuna basınız.<br/><br/></p>' +
					'<u>Olabildiğince hızlı bir şekilde </u> doğru cevapları vermeye çalışınız.<br/><br/></p>'+
					'<p align="center">Lütfen deneye başlayamaya hazır olduğunuzda, <b>boşluk tuşuna</b> basınız.</font></p></div>',
				...
				instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
					'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
					'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
					'Bu bölümde sizden "Giyecek" veya "Alet" kategorisine ait nesneler ile "Kadın" veya "Erkek" yüzlerini kategorilere ayırmanız istenecektir.<br/><br/></p>' +
					'Lütfen sol el parmağınızı klavyenizdeki E tuşunun üzerine, sağ el parmağınızı ise I tuşunun üzerine yerleştiriniz.<br/><br/></p>' +
					'<font color="#336600">leftCategory</font> ya da <font color="#0000ff">leftAttribute</font> kategorileri için <b>E</b> tuşuna basınız.<br/>' +
					'<font color="#336600">rightCategory</font> ya da <font color="#0000ff">rightAttribute</font> kategorileri için <b>I</b> tuşuna basınız.<br/><br/></p>' +
					'<u>Olabildiğince hızlı bir şekilde </u> doğru cevapları vermeye çalışınız.<br/><br/></p>' +
					'<p align="center">Lütfen deneye başlayamaya hazır olduğunuzda, <b>boşluk tuşuna</b> basınız.</font></p></div>',
				...
				instSecondCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
					'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
					'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
					'<p align="center">Bu bölüm biraz önceki bölümün aynısıdır.<br/><br/></p>' +
					'<font color="#336600">leftCategory</font> ya da <font color="#0000ff">leftAttribute</font> kategorileri için <b>E</b> tuşuna basınız.<br/>' +
					'<font color="#336600">rightCategory</font> ya da <font color="#0000ff">rightAttribute</font> kategorileri için <b>I</b> tuşuna basınız.<br/><br/></p>' +
					'<u>Olabildiğince hızlı bir şekilde </u> doğru cevapları vermeye çalışınız.<br/><br/></p>' +
					'<p align="center">Lütfen deneye başlayamaya hazır olduğunuzda, <b>boşluk tuşuna</b> basınız.</font></p></div>',
